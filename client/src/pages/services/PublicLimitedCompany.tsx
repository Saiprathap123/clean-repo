...
export default function PublicLimitedCompany() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description:
        "Enhanced trust and reputation with stakeholders and investors",
    },
    {
      title: "Better Access to Loans",
      description:
        "Easier access to bank loans and external funding opportunities",
    },
    {
    ...
    },
    {
      ...
      description:
        "Can be listed on BSE, NSE and other recognized stock exchanges",
    },
  ];
  ...
  const processSteps = [
    ...
    },
    {
      ...
      title: "Registration",
      description:
        "File incorporation documents and receive Certificate of Incorporation",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-dark-primary text-white">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Scale your business to new heights! Register a Public Limited
            Company to raise capital from the public, get listed on stock
            exchanges, and build a nationally recognized brand.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-dark-tertiary rounded-xl p-8">
            <p className="text-lg text-gray-300 leading-relaxed">
              A Public Company is a company that is permitted to issue shares to
              the general public and may be listed on a stock exchange. It is
              governed under the Companies Act, 2013, and is required to comply
              with extensive regulatory obligations to protect investors'
              interests. Public companies can raise large amounts of capital
              from the public, making them suitable for businesses planning
              significant expansion or large-scale operations.
            </p>
              ...
              <div className="py-4 px-6">
                <div className="animate-marquee whitespace-nowrap">
                  <span className="text-lg font-bold text-white mx-8">
                    ⚠️ Public Company Suits Listing Needs; Private Offers
                    Simpler Operations. Private Company Preferred Unless Public
                    Listing is Planned ⚠️
                  </span>
                  <span className="text-lg font-bold text-white mx-8">
                    ⚠️ Public Company Suits Listing Needs; Private Offers
                    Simpler Operations. Private Company Preferred Unless Public
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-white mb-12 text-center">
            Key Requirements for Public Company
          </h2>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="bg-dark-secondary rounded-xl p-6 hover:bg-dark-tertiary transition-all duration-300"
              >
          ...
          <div className="bg-dark-tertiary rounded-xl p-8">
            <div className="grid gap-4">
              {documentsRequired.map((document, index) => (
                <div
                  key={index}
                  className="flex items-start gap-4 p-4 bg-dark-hover rounded-lg"
                >
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-white mb-12 text-center">
            Who Should Choose Public Limited Company?
          </h2>
          <p className="text-lg text-gray-300 mb-8 text-center">
            A Public Company is suitable for businesses with ambitious growth
            plans:
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-dark-tertiary">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Transform your business vision into reality with Public Limited
            Company registration. Access public capital markets and build a
            nationally recognized enterprise.
          </p>
          <Button onClick={() => setIsBookingModalOpen(true)}>
